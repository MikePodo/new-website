      ...
      <div className={styles.contentContainer}>
          ...
          <div className={styles.tabPanel}>
            ...
            <ul>
              <li>
                ...
                gamers to communicate, share statistics, configure profiles, and
                supplement gameplay.
              </li>
              <li>
        ...
        {value === 1 && (
          <div className={styles.tabPanel}>
            ...
            <ul>
              <li>
                <span>Auto Bidding:</span> Built full user interface and backend
                integrations for a bidding system in which users can setup
                automatic campaign preferences to place bids on promising
                up-and-coming athletic videos.
              </li>
              <li>
        ...
        {value === 2 && (
          <div className={styles.tabPanel}>
            ...
            <ul>
              <li>
                <span>Reviews:</span> Developed a review system allowing the UI
                to reflect review stars and comments left by customers.
              </li>
              <li>
          ...
          <div className={styles.tabPanel}>
            ...
            <ul>
              <li>
                ...
                integrate and manage incoming and outgoing bank transactions via
